...
pub type R = crate::R<GPTIMER1CTRL_SPEC>;
#[doc = "Register `GPTIMER1CTRL` writer"]
pub type W = crate::W<GPTIMER1CTRL_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn gptmode(&mut self) -> GPTMODE_W<GPTIMER1CTRL_SPEC> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn gptrst(&mut self) -> GPTRST_W<GPTIMER1CTRL_SPEC> {
        GPTRST_W::new(self, 30)
    }
    #[doc = "Bit 31 - GPTRUN General Purpose Timer Run GPTCNT bits are not effected when setting or clearing this bit. 0 - Stop counting 1 - Run"]
    #[inline(always)]
    #[must_use]
    pub fn gptrun(&mut self) -> GPTRUN_W<GPTIMER1CTRL_SPEC> {
