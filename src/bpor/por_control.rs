...
pub type R = crate::R<POR_CONTROL_SPEC>;
#[doc = "Register `POR_CONTROL` writer"]
pub type W = crate::W<POR_CONTROL_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn counter(&mut self) -> COUNTER_W<POR_CONTROL_SPEC> {
...
#[doc = "Power down control\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`por_control::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`por_control::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
