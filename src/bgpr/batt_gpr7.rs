...
pub type R = crate::R<BATT_GPR7_SPEC>;
#[doc = "Register `BATT_GPR7` writer"]
pub type W = crate::W<BATT_GPR7_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn gpr(&mut self) -> GPR_W<BATT_GPR7_SPEC> {
        GPR_W::new(self, 0)
    }
...
#[doc = "Generic control\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`batt_gpr7::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`batt_gpr7::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
