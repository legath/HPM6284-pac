...
pub type R = crate::R<BTN_STATUS_SPEC>;
#[doc = "Register `BTN_STATUS` writer"]
pub type W = crate::W<BTN_STATUS_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pbtn(&mut self) -> PBTN_W<BTN_STATUS_SPEC> {
        PBTN_W::new(self, 0)
    }
    #[doc = "Bits 4:7 - Wake button press status, write 1 to clear flag bit0: button pressed bit1: button confirmd bit2: button long pressed bit3: button long long pressed"]
    #[inline(always)]
    #[must_use]
    pub fn wbtn(&mut self) -> WBTN_W<BTN_STATUS_SPEC> {
        WBTN_W::new(self, 4)
    }
    #[doc = "Bits 8:11 - Dual button press status, write 1 to clear flag bit0: button pressed bit1: button confirmd bit2: button long pressed bit3: button long long pressed"]
    #[inline(always)]
    #[must_use]
    pub fn dbtn(&mut self) -> DBTN_W<BTN_STATUS_SPEC> {
        DBTN_W::new(self, 8)
    }
    #[doc = "Bits 16:18 - power button click status, write 1 to clear flag bit0: clicked bit1: double clicked bit2: tripple clicked"]
    #[inline(always)]
    #[must_use]
    pub fn pclick(&mut self) -> PCLICK_W<BTN_STATUS_SPEC> {
        PCLICK_W::new(self, 16)
    }
    #[doc = "Bits 20:22 - power button click status when wake button held, write 1 to clear flag bit0: clicked bit1: double clicked bit2: tripple clicked"]
    #[inline(always)]
    #[must_use]
    pub fn xpclick(&mut self) -> XPCLICK_W<BTN_STATUS_SPEC> {
        XPCLICK_W::new(self, 20)
    }
    #[doc = "Bits 24:26 - wake button click status, write 1 to clear flag bit0: clicked bit1: double clicked bit2: tripple clicked"]
    #[inline(always)]
    #[must_use]
    pub fn wclick(&mut self) -> WCLICK_W<BTN_STATUS_SPEC> {
        WCLICK_W::new(self, 24)
    }
    #[doc = "Bits 28:30 - wake button click status when power button held, write 1 to clear flag bit0: clicked bit1: double clicked bit2: tripple clicked"]
    #[inline(always)]
    #[must_use]
    pub fn xwclick(&mut self) -> XWCLICK_W<BTN_STATUS_SPEC> {
...
#[doc = "Button status\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`btn_status::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`btn_status::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
