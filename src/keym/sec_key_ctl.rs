...
pub type R = crate::R<SEC_KEY_CTL_SPEC>;
#[doc = "Register `SEC_KEY_CTL` writer"]
pub type W = crate::W<SEC_KEY_CTL_SPEC>;
...
pub type LOCK_SEC_CTL_R = crate::BitReader;
#[doc = "Field `LOCK_SEC_CTL` writer - block secure state key setting being changed"]
pub type LOCK_SEC_CTL_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn key_sel(&mut self) -> KEY_SEL_W<SEC_KEY_CTL_SPEC> {
        KEY_SEL_W::new(self, 0)
    }
    #[doc = "Bit 4 - fuse symmetric key selection 0: use scramble version of fuse symmetric key 1: use alnertave scramble of fuse symmetric key"]
    #[inline(always)]
    #[must_use]
    pub fn fmk_sel(&mut self) -> FMK_SEL_W<SEC_KEY_CTL_SPEC> {
        FMK_SEL_W::new(self, 4)
    }
    #[doc = "Bit 8 - batt symmetric key selection 0: use scramble version of software symmetric key 1: use origin value in software symmetric key"]
    #[inline(always)]
    #[must_use]
    pub fn zmk_sel(&mut self) -> ZMK_SEL_W<SEC_KEY_CTL_SPEC> {
        ZMK_SEL_W::new(self, 8)
    }
    #[doc = "Bit 12 - software symmetric key selection 0: use origin value in software symmetric key 1: use scramble version of software symmetric key"]
    #[inline(always)]
    #[must_use]
    pub fn smk_sel(&mut self) -> SMK_SEL_W<SEC_KEY_CTL_SPEC> {
        SMK_SEL_W::new(self, 12)
    }
    #[doc = "Bit 31 - block secure state key setting being changed"]
    #[inline(always)]
    #[must_use]
    pub fn lock_sec_ctl(&mut self) -> LOCK_SEC_CTL_W<SEC_KEY_CTL_SPEC> {
        LOCK_SEC_CTL_W::new(self, 31)
    }
