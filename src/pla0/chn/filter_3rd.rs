#[doc = "Register `FILTER_3RD[%s]` reader"]
pub type R = crate::R<FILTER_3RD_SPEC>;
#[doc = "Register `FILTER_3RD[%s]` writer"]
pub type W = crate::W<FILTER_3RD_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sync_edge_filter_enable(&mut self) -> SYNC_EDGE_FILTER_ENABLE_W<FILTER_3RD_SPEC> {
        SYNC_EDGE_FILTER_ENABLE_W::new(self, 0)
    }
    #[doc = "Bits 1:2 - software inject value for sync and edge detector filter. 0: inject low level. 1: inject high level. 2: not inject. 3. inject high level."]
    #[inline(always)]
    #[must_use]
    pub fn software_inject(&mut self) -> SOFTWARE_INJECT_W<FILTER_3RD_SPEC> {
        SOFTWARE_INJECT_W::new(self, 1)
    }
    #[doc = "Bit 3 - reverse sync and edge detector filter's output. 0: not reverse. 1: reverse."]
    #[inline(always)]
    #[must_use]
    pub fn filter_reverse(&mut self) -> FILTER_REVERSE_W<FILTER_3RD_SPEC> {
        FILTER_REVERSE_W::new(self, 3)
    }
    #[doc = "Bit 4 - edge detector enable. 0: disable. bit6/bit5 setting inactive. 1: enable. bit6/bit5 setting active."]
    #[inline(always)]
    #[must_use]
    pub fn edge_dect_enable(&mut self) -> EDGE_DECT_ENABLE_W<FILTER_3RD_SPEC> {
        EDGE_DECT_ENABLE_W::new(self, 4)
    }
    #[doc = "Bit 5 - nege edge detector enable. 0: disable. 1: enable."]
    #[inline(always)]
    #[must_use]
    pub fn nege_edge_dect_enable(&mut self) -> NEGE_EDGE_DECT_ENABLE_W<FILTER_3RD_SPEC> {
        NEGE_EDGE_DECT_ENABLE_W::new(self, 5)
    }
    #[doc = "Bit 6 - pose edge detector enable. 0: disable. 1: enable."]
    #[inline(always)]
    #[must_use]
    pub fn pose_edge_dect_enable(&mut self) -> POSE_EDGE_DECT_ENABLE_W<FILTER_3RD_SPEC> {
        POSE_EDGE_DECT_ENABLE_W::new(self, 6)
    }
    #[doc = "Bit 7 - synchroniser level. 0: 2 level sync. 1: 3 level sync"]
    #[inline(always)]
    #[must_use]
    pub fn filter_sync_level(&mut self) -> FILTER_SYNC_LEVEL_W<FILTER_3RD_SPEC> {
        FILTER_SYNC_LEVEL_W::new(self, 7)
    }
    #[doc = "Bit 8 - filter extend enable. 0. bypass filter extend. all setting in bit31:12 are inactive 1. enable filter extend, all setting in bit31:12 are active."]
    #[inline(always)]
    #[must_use]
    pub fn filter_ext_enable(&mut self) -> FILTER_EXT_ENABLE_W<FILTER_3RD_SPEC> {
        FILTER_EXT_ENABLE_W::new(self, 8)
    }
    #[doc = "Bits 12:14 - filter extend type. 0-3：nothing to do. 4： input high level extend. 5： input low level extend. 6： output extend. 7： input pulse extend."]
    #[inline(always)]
    #[must_use]
    pub fn filter_ext_type(&mut self) -> FILTER_EXT_TYPE_W<FILTER_3RD_SPEC> {
        FILTER_EXT_TYPE_W::new(self, 12)
    }
    #[doc = "Bits 16:31 - filter_ext counter value, cycles for filter or extent by system clock。 0：0*apb_clk_period 1：1*apb_clk_period 2: 2*apb_clk_period … 65535: 65535*apb_clk_period"]
    #[inline(always)]
    #[must_use]
    pub fn filter_ext_counter(&mut self) -> FILTER_EXT_COUNTER_W<FILTER_3RD_SPEC> {
...
#[doc = "no description available\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`filter_3rd::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`filter_3rd::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct FILTER_3RD_SPEC;
impl crate::RegisterSpec for FILTER_3RD_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`filter_3rd::R`](R) reader structure"]
impl crate::Readable for FILTER_3RD_SPEC {}
#[doc = "`write(|w| ..)` method takes [`filter_3rd::W`](W) writer structure"]
impl crate::Writable for FILTER_3RD_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets FILTER_3RD[%s]
to value 0"]
impl crate::Resettable for FILTER_3RD_SPEC {
