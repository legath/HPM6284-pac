#[doc = "Register `CLOCK_CPU[%s]` reader"]
pub type R = crate::R<CLOCK_CPU_SPEC>;
#[doc = "Register `CLOCK_CPU[%s]` writer"]
pub type W = crate::W<CLOCK_CPU_SPEC>;
...
#[doc = "Field `SUB0_DIV` reader - axi bus divider, the bus clock is generated by cpu_clock/div 0: divider by 1 1: divider by 2 …"]
pub type SUB0_DIV_R = crate::FieldReader;
#[doc = "Field `SUB0_DIV` writer - axi bus divider, the bus clock is generated by cpu_clock/div 0: divider by 1 1: divider by 2 …"]
pub type SUB0_DIV_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
#[doc = "Field `SUB1_DIV` reader - ahb bus divider, the bus clock is generated by cpu_clock/div 0: divider by 1 1: divider by 2 …"]
pub type SUB1_DIV_R = crate::FieldReader;
#[doc = "Field `SUB1_DIV` writer - ahb bus divider, the bus clock is generated by cpu_clock/div 0: divider by 1 1: divider by 2 …"]
pub type SUB1_DIV_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
...
impl R {
    ...
    #[doc = "Bits 16:19 - axi bus divider, the bus clock is generated by cpu_clock/div 0: divider by 1 1: divider by 2 …"]
    #[inline(always)]
    pub fn sub0_div(&self) -> SUB0_DIV_R {
        SUB0_DIV_R::new(((self.bits >> 16) & 0x0f) as u8)
    }
    #[doc = "Bits 20:23 - ahb bus divider, the bus clock is generated by cpu_clock/div 0: divider by 1 1: divider by 2 …"]
    #[inline(always)]
    pub fn sub1_div(&self) -> SUB1_DIV_R {
        SUB1_DIV_R::new(((self.bits >> 20) & 0x0f) as u8)
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn div(&mut self) -> DIV_W<CLOCK_CPU_SPEC> {
        DIV_W::new(self, 0)
    }
    #[doc = "Bits 8:10 - current mux in clock component 0:osc0_clk0 1:pll0_clk0 2:pll0_clk1 3:pll0_clk2 4:pll1_clk0 5:pll1_clk1 6:pll2_clk0 7:pll2_clk1"]
    #[inline(always)]
    #[must_use]
    pub fn mux(&mut self) -> MUX_W<CLOCK_CPU_SPEC> {
        MUX_W::new(self, 8)
    }
    #[doc = "Bits 16:19 - axi bus divider, the bus clock is generated by cpu_clock/div 0: divider by 1 1: divider by 2 …"]
    #[inline(always)]
    #[must_use]
    pub fn sub0_div(&mut self) -> SUB0_DIV_W<CLOCK_CPU_SPEC> {
        SUB0_DIV_W::new(self, 16)
    }
    #[doc = "Bits 20:23 - ahb bus divider, the bus clock is generated by cpu_clock/div 0: divider by 1 1: divider by 2 …"]
    #[inline(always)]
    #[must_use]
    pub fn sub1_div(&mut self) -> SUB1_DIV_W<CLOCK_CPU_SPEC> {
        SUB1_DIV_W::new(self, 20)
    }
    #[doc = "Bit 28 - preserve function against global select 0: select global clock setting 1: not select global clock setting"]
    #[inline(always)]
    #[must_use]
    pub fn preserve(&mut self) -> PRESERVE_W<CLOCK_CPU_SPEC> {
...
pub struct CLOCK_CPU_SPEC;
impl crate::RegisterSpec for CLOCK_CPU_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`clock_cpu::R`](R) reader structure"]
impl crate::Readable for CLOCK_CPU_SPEC {}
#[doc = "`write(|w| ..)` method takes [`clock_cpu::W`](W) writer structure"]
impl crate::Writable for CLOCK_CPU_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CLOCK_CPU[%s]
to value 0"]
impl crate::Resettable for CLOCK_CPU_SPEC {
