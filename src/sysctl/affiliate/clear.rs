...
#[doc = "Field `LINK` reader - Affiliate groups of cpu0, each bit represents a group 0: no effect 1: the group is not assigned to CPU0"]
pub type LINK_R = crate::FieldReader;
#[doc = "Field `LINK` writer - Affiliate groups of cpu0, each bit represents a group 0: no effect 1: the group is not assigned to CPU0"]
pub type LINK_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
impl R {
    #[doc = "Bits 0:3 - Affiliate groups of cpu0, each bit represents a group 0: no effect 1: the group is not assigned to CPU0"]
    #[inline(always)]
