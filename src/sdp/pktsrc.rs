...
pub type R = crate::R<PKTSRC_SPEC>;
#[doc = "Register `PKTSRC` writer"]
pub type W = crate::W<PKTSRC_SPEC>;
#[doc = "Field `PKTSRC` reader - Packet Memory Source Address"]
pub type PKTSRC_R = crate::FieldReader<u32>;
#[doc = "Field `PKTSRC` writer - Packet Memory Source Address"]
pub type PKTSRC_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pktsrc(&mut self) -> PKTSRC_W<PKTSRC_SPEC> {
        PKTSRC_W::new(self, 0)
    }
