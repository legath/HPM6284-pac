...
pub type R = crate::R<ALARM1_INC_SPEC>;
#[doc = "Register `ALARM1_INC` writer"]
pub type W = crate::W<ALARM1_INC_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn increase(&mut self) -> INCREASE_W<ALARM1_INC_SPEC> {
...
#[doc = "Alarm1 incremental\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`alarm1_inc::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`alarm1_inc::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
