...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn wdog(&mut self) -> WDOG_W<INT_EN_SPEC> {
        WDOG_W::new(self, 0)
    }
    #[doc = "Bit 21 - set if got hresp=1, generally caused by wrong trg_dma_addr or seq_dma_addr"]
    #[inline(always)]
    #[must_use]
    pub fn ahb_err(&mut self) -> AHB_ERR_W<INT_EN_SPEC> {
        AHB_ERR_W::new(self, 21)
    }
    #[doc = "Bit 22 - DMA fifo full interrupt, user need to check clock frequency if it's set."]
    #[inline(always)]
    #[must_use]
    pub fn dma_fifo_full(&mut self) -> DMA_FIFO_FULL_W<INT_EN_SPEC> {
        DMA_FIFO_FULL_W::new(self, 22)
    }
    #[doc = "Bit 23 - one conversion complete in seq_queue if related seq_int_en is set"]
    #[inline(always)]
    #[must_use]
    pub fn seq_cvc(&mut self) -> SEQ_CVC_W<INT_EN_SPEC> {
        SEQ_CVC_W::new(self, 23)
    }
    #[doc = "Bit 24 - the whole sequence complete interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn seq_cmpt(&mut self) -> SEQ_CMPT_W<INT_EN_SPEC> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn seq_dmaabt(&mut self) -> SEQ_DMAABT_W<INT_EN_SPEC> {
        SEQ_DMAABT_W::new(self, 25)
    }
    #[doc = "Bit 26 - No description avaiable"]
    #[inline(always)]
    #[must_use]
    pub fn seq_hw_cflct(&mut self) -> SEQ_HW_CFLCT_W<INT_EN_SPEC> {
        SEQ_HW_CFLCT_W::new(self, 26)
    }
    #[doc = "Bit 27 - sequence queue conflict interrup, set if HW or SW trigger received during conversion"]
    #[inline(always)]
    #[must_use]
    pub fn seq_sw_cflct(&mut self) -> SEQ_SW_CFLCT_W<INT_EN_SPEC> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn read_cflct(&mut self) -> READ_CFLCT_W<INT_EN_SPEC> {
        READ_CFLCT_W::new(self, 28)
    }
    #[doc = "Bit 29 - No description avaiable"]
    #[inline(always)]
    #[must_use]
    pub fn trig_hw_cflct(&mut self) -> TRIG_HW_CFLCT_W<INT_EN_SPEC> {
        TRIG_HW_CFLCT_W::new(self, 29)
    }
    #[doc = "Bit 30 - No description avaiable"]
    #[inline(always)]
    #[must_use]
    pub fn trig_sw_cflct(&mut self) -> TRIG_SW_CFLCT_W<INT_EN_SPEC> {
        TRIG_SW_CFLCT_W::new(self, 30)
    }
    #[doc = "Bit 31 - interrupt for one trigger conversion complete if enabled"]
    #[inline(always)]
    #[must_use]
    pub fn trig_cmpt(&mut self) -> TRIG_CMPT_W<INT_EN_SPEC> {
