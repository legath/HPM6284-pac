#[doc = "Register `FUSE_LOCK[%s]` reader"]
pub type R = crate::R<FUSE_LOCK_SPEC>;
#[doc = "Register `FUSE_LOCK[%s]` writer"]
pub type W = crate::W<FUSE_LOCK_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn lock(&mut self) -> LOCK_W<FUSE_LOCK_SPEC> {
        LOCK_W::new(self, 0)
    }
...
pub struct FUSE_LOCK_SPEC;
impl crate::RegisterSpec for FUSE_LOCK_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fuse_lock::R`](R) reader structure"]
impl crate::Readable for FUSE_LOCK_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fuse_lock::W`](W) writer structure"]
impl crate::Writable for FUSE_LOCK_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets FUSE_LOCK[%s]
to value 0"]
impl crate::Resettable for FUSE_LOCK_SPEC {
